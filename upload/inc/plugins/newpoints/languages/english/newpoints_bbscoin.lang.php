...
$l['newpoints_bbscoin_topoint_transactiontips'] = "Please transfer required BBSCoin to the address below with the Payment ID above, then fill in the blank. ";
...
$l['newpoints_bbscoin_paymentid_error'] = "Deposit Payment ID is incorrect";
$l['newpoints_bbscoin_paymentid'] = "Payment ID";
$l['newpoints_bbscoin_paymentid_desc'] = "You need fill this Payment ID when you transfer BBSCoin to site wallet address.";
...
$l['newpoints_bbscoin_withdraw_succ'] = "Your withdraw is successful. The transaction hash is {1}, withdrew {2} points.";
...
$l['newpoints_bbscoin_deposit_wait'] = "Your deposit will be processed when we confirm your transfer automatically";
$l['newpoints_bbscoin_deposit_failed'] = "Your deposit is failed, please try again.";
$l['newpoints_bbscoin_withdraw_failed'] = "Your withdraw is failed";
$l['newpoints_bbscoin_withdraw_failed_desc'] = "Your withdraw is failed. We returned your points. The order id is {1}.";
$l['newpoints_bbscoin_succ_desc'] = "Your deposit is successful, deposited {1} points, transaction hash is {2}.";
$l['newpoints_bbscoin_withdraw_succ_title'] = "Your withdraw is successful";
